...
import 'package:mynetflix/presentation/Widgets/app_bar_widget.dart';
...
class Section2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      BlocProvider.of<DownloadsBloc>(context).add(GetdownlodsimagesEvent());
    });
    return Column(
      children: [
        const Text(
        ...
        BlocBuilder<DownloadsBloc, DownloadsState>(builder: (context, state) {
          if (state is DownloadsImageFetchSuccessState) {
            return SizedBox(
              width: size.width,
              height: size.width,
