...
import 'package:mynetflix/presentation/home/widgets/animated_hori_scroll.dart';
import 'package:mynetflix/presentation/home/widgets/horizontal_scroll.dart';
import 'package:mynetflix/presentation/home/widgets/top_section.dart';
    ...
    return RefreshIndicator(
      ...
      child: BlocListener<HomeBloc, HomeState>(
        listener: (context, state) {
          if (state is HomeInitialSuccessState) {
      print("Past Year List: ${state.pastYearList}");
      print("Trending Movie List: ${state.trendingMovieList}");
      print("Tense Drama List: ${state.tenseDramaList}");
      print("South Indian List: ${state.southIndianList}");
      print("Trending TV List: ${state.trendingTvList}");
    }
        },
        child: Scaffold(
                            ...
                            return Column(
                              ...
                              children: [
                                const Text(
                                  ...
                                  style:
                                      TextStyle(color: whiteclr, fontSize: 18),
                                ),
                                TextButton(
                                    onPressed: () {
